  ...
  <div class="row">
      ...
      <div class="col md-6">
          ...
          <div class="mb-3">
              ...
              <input type="url" class="form-control" id="thumb" name='thumb' value='{{ $project->thumb }}'
                  required>
  ...
  <div class="row">
      ...
      <div class="mb-3">
          ...
          <textarea class="form-control" id="description" name='description' rows="8">{{ $project->description }}</textarea>
      </div>
  </div>
  <hr>
